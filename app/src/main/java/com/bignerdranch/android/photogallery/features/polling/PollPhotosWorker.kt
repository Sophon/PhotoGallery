package com.bignerdranch.android.photogallery.features.polling
...
import com.bignerdranch.android.photogallery.app.NOTIFICATION_CHANNEL_ID
import com.bignerdranch.android.photogallery.features.photoGallery.PhotoGalleryActivity
...
class PollPhotosWorker(private val context: Context, workerParams: WorkerParameters)
    ...
    private fun createBackgroundNotification() {
        ...
        context.sendOrderedBroadcast(notificationIntent,
            PERM_PRIVATE
        )
    }
}