...
class PhotoGalleryFragment: VisibleFragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        val search = menu.findItem(R.id.gallery_menu_search)
        if(photoGalleryViewModel.getGalleryType() == GalleryType.ONLINE) {
            setupSearch(menu)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        photoGalleryViewModel.galleryTypeLiveData.observe(
            viewLifecycleOwner,
            Observer {
